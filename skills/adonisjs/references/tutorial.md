...
**URL:** https://docs.adonisjs.com/tutorial/hypermedia/overview.md
...
:::note We'll use the `auth` middleware throughout the tutorial to protect routes that require authentication. :::
...
You might notice the controller references a `User` model and a `signupValidator`. The starter kit already includes these. We'll explore how models work in the [Database and Models](./database*and*models.md) chapter and validators in the [Forms and Validation](./forms*and*validation.md) chapter.
